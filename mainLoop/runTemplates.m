...
for j = 1:Nfilt
    ...
    % fprintf('compressing templates for unit: %d\n', j);
    ...
    try
        ...
        fprintf('error in gpu svdecon of WA for template %d, using cpu\n',j);
        [A, B, C] = svd(WA,'econ');
    end
    ...
    try
        ...
        fprintf('error in gpu svdecon of UA for template %d, using cpu\n',j);
        [A, B, C] = svd(UA,'econ');
    end
